...
export const metadata: Metadata = {
  ...
  keywords: [
    "in-app chat that finishes tasks",
    "embed assistant that acts in your product",
    "product activation assistant",
    "in-app agent navigate and call APIs",
  ...
  "@graph": [
    ...
    },
    {
      ...
      featureList: [
        ...
        "Finishes in-product tasks so users don’t stall or leave",
        "Embed with two script tags — no backend rewrite",
        "Completes workflows instead of explaining docs",
